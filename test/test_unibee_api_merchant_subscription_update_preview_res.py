...
class TestUnibeeApiMerchantSubscriptionUpdatePreviewRes(unittest.TestCase):
    """UnibeeApiMerchantSubscriptionUpdatePreviewRes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnibeeApiMerchantSubscriptionUpdatePreviewRes:
        """Test UnibeeApiMerchantSubscriptionUpdatePreviewRes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnibeeApiMerchantSubscriptionUpdatePreviewRes`
        """
        model = UnibeeApiMerchantSubscriptionUpdatePreviewRes()
        if include_optional:
            return UnibeeApiMerchantSubscriptionUpdatePreviewRes(
                currency = '',
    ...
    def testUnibeeApiMerchantSubscriptionUpdatePreviewRes(self):
        """Test UnibeeApiMerchantSubscriptionUpdatePreviewRes"""
