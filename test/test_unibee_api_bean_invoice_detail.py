...
class TestUnibeeApiBeanInvoiceDetail(unittest.TestCase):
    """UnibeeApiBeanInvoiceDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnibeeApiBeanInvoiceDetail:
        """Test UnibeeApiBeanInvoiceDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnibeeApiBeanInvoiceDetail`
        """
        model = UnibeeApiBeanInvoiceDetail()
        if include_optional:
            return UnibeeApiBeanInvoiceDetail(
                currency = '',
                data = '',
                discount_amount = 56,
    ...
    def testUnibeeApiBeanInvoiceDetail(self):
        """Test UnibeeApiBeanInvoiceDetail"""
