...
class TestMerchantSubscriptionCreatePreviewPost200ResponseData(unittest.TestCase):
    """MerchantSubscriptionCreatePreviewPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantSubscriptionCreatePreviewPost200ResponseData:
        """Test MerchantSubscriptionCreatePreviewPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantSubscriptionCreatePreviewPost200ResponseData`
        """
        model = MerchantSubscriptionCreatePreviewPost200ResponseData()
        if include_optional:
            return MerchantSubscriptionCreatePreviewPost200ResponseData(
                addon_params = [
    ...
    def testMerchantSubscriptionCreatePreviewPost200ResponseData(self):
        """Test MerchantSubscriptionCreatePreviewPost200ResponseData"""
