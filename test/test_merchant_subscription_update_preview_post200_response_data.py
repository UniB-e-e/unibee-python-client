...
class TestMerchantSubscriptionUpdatePreviewPost200ResponseData(unittest.TestCase):
    """MerchantSubscriptionUpdatePreviewPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantSubscriptionUpdatePreviewPost200ResponseData:
        """Test MerchantSubscriptionUpdatePreviewPost200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantSubscriptionUpdatePreviewPost200ResponseData`
        """
        model = MerchantSubscriptionUpdatePreviewPost200ResponseData()
        if include_optional:
            return MerchantSubscriptionUpdatePreviewPost200ResponseData(
                currency = '',
    ...
    def testMerchantSubscriptionUpdatePreviewPost200ResponseData(self):
        """Test MerchantSubscriptionUpdatePreviewPost200ResponseData"""
