...
class TestUnibeeApiMerchantMetricNewEventRes(unittest.TestCase):
    """UnibeeApiMerchantMetricNewEventRes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnibeeApiMerchantMetricNewEventRes:
        """Test UnibeeApiMerchantMetricNewEventRes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnibeeApiMerchantMetricNewEventRes`
        """
        model = UnibeeApiMerchantMetricNewEventRes()
        if include_optional:
            return UnibeeApiMerchantMetricNewEventRes(
    ...
    def testUnibeeApiMerchantMetricNewEventRes(self):
        """Test UnibeeApiMerchantMetricNewEventRes"""
