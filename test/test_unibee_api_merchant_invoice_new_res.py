...
class TestUnibeeApiMerchantInvoiceNewRes(unittest.TestCase):
    """UnibeeApiMerchantInvoiceNewRes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnibeeApiMerchantInvoiceNewRes:
        """Test UnibeeApiMerchantInvoiceNewRes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnibeeApiMerchantInvoiceNewRes`
        """
        model = UnibeeApiMerchantInvoiceNewRes()
        if include_optional:
            return UnibeeApiMerchantInvoiceNewRes(
    ...
    def testUnibeeApiMerchantInvoiceNewRes(self):
        """Test UnibeeApiMerchantInvoiceNewRes"""
