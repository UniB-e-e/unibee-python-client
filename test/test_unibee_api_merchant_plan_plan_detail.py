...
class TestUnibeeApiMerchantPlanPlanDetail(unittest.TestCase):
    """UnibeeApiMerchantPlanPlanDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnibeeApiMerchantPlanPlanDetail:
        """Test UnibeeApiMerchantPlanPlanDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnibeeApiMerchantPlanPlanDetail`
        """
        model = UnibeeApiMerchantPlanPlanDetail()
        if include_optional:
            return UnibeeApiMerchantPlanPlanDetail(
                addon_ids = [
                    56
                    ],
                addons = [
    ...
    def testUnibeeApiMerchantPlanPlanDetail(self):
        """Test UnibeeApiMerchantPlanPlanDetail"""
