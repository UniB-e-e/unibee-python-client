...
class UnibeeApiMerchantSubscriptionAddNewTrialStartReq(BaseModel):
    """
    UnibeeApiMerchantSubscriptionAddNewTrialStartReq
    """ # noqa: E501
    append_trial_end_hour: StrictInt = Field(description="add appendTrialEndHour For Free", alias="appendTrialEndHour")
    subscription_id: StrictStr = Field(description="SubscriptionId", alias="subscriptionId")
    __properties: ClassVar[List[str]] = ["appendTrialEndHour", "subscriptionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appendTrialEndHour": obj.get("appendTrialEndHour"),
