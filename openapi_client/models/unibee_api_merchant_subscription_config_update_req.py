...
class UnibeeApiMerchantSubscriptionConfigUpdateReq(BaseModel):
    """
    UnibeeApiMerchantSubscriptionConfigUpdateReq
    """ # noqa: E501
    downgrade_effect_immediately: Optional[StrictBool] = Field(default=None, description="DowngradeEffectImmediately, whether subscription downgrade should effect immediately or at period end, default at period end", alias="downgradeEffectImmediately")
