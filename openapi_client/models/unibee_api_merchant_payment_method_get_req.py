...
class UnibeeApiMerchantPaymentMethodGetReq(BaseModel):
    """
    UnibeeApiMerchantPaymentMethodGetReq
    """ # noqa: E501
    gateway_id: StrictInt = Field(description="GatewayId", alias="gatewayId")
    payment_method_id: StrictStr = Field(description="PaymentMethodId", alias="paymentMethodId")
    user_id: StrictInt = Field(description="UserId", alias="userId")
    __properties: ClassVar[List[str]] = ["gatewayId", "paymentMethodId", "userId"]
