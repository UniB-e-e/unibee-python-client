...
class UnibeeApiBeanPlanSimplify(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "bindingAddonIds", "bindingOnetimeAddonIds", "createTime", "currency", "description", "extraMetricData", "gasPayer", "homeUrl", "id", "imageUrl", "intervalCount", "intervalUnit", "merchantId", "metadata", "planName", "productDescription", "productName", "publishStatus", "status", "taxPercentage", "type"]
