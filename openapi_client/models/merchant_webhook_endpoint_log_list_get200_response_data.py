...
class MerchantWebhookEndpointLogListGet200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in endpoint_log_list (list)
        _items = []
        if self.endpoint_log_list:
            for _item in self.endpoint_log_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['endpointLogList'] = _items
        return _dict
