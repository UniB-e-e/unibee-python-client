...
class UnibeeApiSystemInvoiceChannelSyncReq(BaseModel):
    """
    UnibeeApiSystemInvoiceChannelSyncReq
    """ # noqa: E501
    invoice_id: StrictStr = Field(description="invoiceId", alias="invoiceId")
    merchant_id: StrictStr = Field(description="merchantId", alias="merchantId")
    __properties: ClassVar[List[str]] = ["invoiceId", "merchantId"]
