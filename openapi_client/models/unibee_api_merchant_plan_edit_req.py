...
class UnibeeApiMerchantPlanEditReq(BaseModel):
    ...
    interval_count: Optional[StrictInt] = Field(default=None, description="Number Of IntervalUnit", alias="intervalCount")
    ...
    __properties: ClassVar[List[str]] = ["addonIds", "amount", "currency", "description", "gasPayer", "homeUrl", "imageUrl", "intervalCount", "intervalUnit", "metadata", "metricLimits", "onetimeAddonIds", "planId", "planName", "productDescription", "productName"]
