...
class UnibeeApiMerchantPlanEditReq(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addonIds", "amount", "currency", "description", "gasPayer", "homeUrl", "imageUrl", "intervalCount", "intervalUnit", "metadata", "metricLimits", "planId", "planName", "productDescription", "productName"]
