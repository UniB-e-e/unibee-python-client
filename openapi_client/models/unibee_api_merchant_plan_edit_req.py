...
class UnibeeApiMerchantPlanEditReq(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addonIds", "amount", "currency", "description", "homeUrl", "imageUrl", "intervalCount", "intervalUnit", "metricLimits", "planId", "planName", "productDescription", "productName"]
