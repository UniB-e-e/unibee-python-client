...
class UnibeeInternalLogicGatewayRoValidResult(BaseModel):
    """
    UnibeeInternalLogicGatewayRoValidResult
    """ # noqa: E501
    company_address: Optional[StrictStr] = Field(default=None, alias="companyAddress")
    company_name: Optional[StrictStr] = Field(default=None, alias="companyName")
    country_code: Optional[StrictStr] = Field(default=None, alias="countryCode")
    valid: Optional[StrictBool] = None
    validate_message: Optional[StrictStr] = Field(default=None, alias="validateMessage")
    vat_number: Optional[StrictStr] = Field(default=None, alias="vatNumber")
    __properties: ClassVar[List[str]] = ["companyAddress", "companyName", "countryCode", "valid", "validateMessage", "vatNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "valid": obj.get("valid"),
            "validateMessage": obj.get("validateMessage"),
