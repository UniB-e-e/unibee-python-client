...
class UnibeeApiMerchantAuthPasswordForgetOtpVerifyReq(BaseModel):
    """
    UnibeeApiMerchantAuthPasswordForgetOtpVerifyReq
    """ # noqa: E501
    email: StrictStr = Field(description="email")
    new_password: StrictStr = Field(description="NewPassword", alias="newPassword")
    verification_code: StrictStr = Field(description="verificationCode", alias="verificationCode")
    __properties: ClassVar[List[str]] = ["email", "newPassword", "verificationCode"]
