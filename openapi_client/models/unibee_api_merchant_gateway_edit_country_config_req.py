...
class UnibeeApiMerchantGatewayEditCountryConfigReq(BaseModel):
    """
    UnibeeApiMerchantGatewayEditCountryConfigReq
    """ # noqa: E501
    country_config: Optional[Dict[str, StrictBool]] = Field(default=None, description="CountryConfig", alias="countryConfig")
    gateway_id: StrictInt = Field(description="GatewayId", alias="gatewayId")
    __properties: ClassVar[List[str]] = ["countryConfig", "gatewayId"]
