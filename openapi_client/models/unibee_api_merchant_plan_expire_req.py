...
class UnibeeApiMerchantPlanExpireReq(BaseModel):
    """
    UnibeeApiMerchantPlanExpireReq
    """ # noqa: E501
    email_code: StrictInt = Field(description="Code From Email", alias="emailCode")
    plan_id: StrictInt = Field(description="PlanId", alias="planId")
    __properties: ClassVar[List[str]] = ["emailCode", "planId"]
