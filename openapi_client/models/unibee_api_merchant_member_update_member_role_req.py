...
class UnibeeApiMerchantMemberUpdateMemberRoleReq(BaseModel):
    """
    UnibeeApiMerchantMemberUpdateMemberRoleReq
    """ # noqa: E501
    member_id: Optional[StrictInt] = Field(default=None, description="MemberId", alias="memberId")
    role: Optional[StrictStr] = Field(default=None, description="Role")
    __properties: ClassVar[List[str]] = ["memberId", "role"]
