...
class UnibeeApiMerchantInvoiceEditReq(BaseModel):
    ...
    tax_percentage: Optional[StrictInt] = Field(default=None, description="TaxPercentage，1000 represent 10%", alias="taxPercentage")
    __properties: ClassVar[List[str]] = ["currency", "finish", "gatewayId", "invoiceId", "lines", "name", "taxPercentage"]
