...
class UnibeeApiMerchantPaymentTimeLineListReq(BaseModel):
    """
    ...
    sort_field: Optional[StrictStr] = Field(default=None, description="Sort，invoice_id|gmt_create|gmt_modify|period_end|total_amount，Default gmt_modify", alias="sortField")
