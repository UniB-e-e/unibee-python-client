...
class UnibeeInternalModelEntityOverseaPayMerchantWebhookLog(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["body", "createTime", "endpointId", "gmtCreate", "gmtModify", "id", "mamo", "merchantId", "reconsumeCount", "requestId", "response", "webhookEvent", "webhookUrl"]
