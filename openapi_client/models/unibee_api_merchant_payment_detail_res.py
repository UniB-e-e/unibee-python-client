...
class UnibeeApiMerchantPaymentDetailRes(BaseModel):
    """
    UnibeeApiMerchantPaymentDetailRes
    """ # noqa: E501
    payment_detail: Optional[UnibeeApiBeanDetailPaymentDetail] = Field(default=None, alias="paymentDetail")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentDetail": UnibeeApiBeanDetailPaymentDetail.from_dict(obj["paymentDetail"]) if obj.get("paymentDetail") is not None else None
        })
        return _obj
