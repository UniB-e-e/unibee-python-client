...
class UnibeeApiMerchantSubscriptionCancelReq(BaseModel):
    """
    UnibeeApiMerchantSubscriptionCancelReq
    """ # noqa: E501
    invoice_now: Optional[StrictBool] = Field(default=None, description="Default false", alias="invoiceNow")
    prorate: Optional[StrictBool] = Field(default=None, description="Prorate Generate Invoice，Default false")
    subscription_id: StrictStr = Field(description="SubscriptionId", alias="subscriptionId")
    __properties: ClassVar[List[str]] = ["invoiceNow", "prorate", "subscriptionId"]
