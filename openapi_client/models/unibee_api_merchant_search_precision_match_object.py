...
class UnibeeApiMerchantSearchPrecisionMatchObject(BaseModel):
    """
    UnibeeApiMerchantSearchPrecisionMatchObject
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = None
    id: Optional[StrictStr] = Field(default=None, description="match Id user_id|invoice_id")
    type: Optional[StrictStr] = Field(default=None, description="match Type, user|invoice")
