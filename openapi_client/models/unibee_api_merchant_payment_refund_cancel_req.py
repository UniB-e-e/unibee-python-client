...
class UnibeeApiMerchantPaymentRefundCancelReq(BaseModel):
    """
    UnibeeApiMerchantPaymentRefundCancelReq
    """ # noqa: E501
    refund_id: StrictStr = Field(description="RefundId", alias="refundId")
    __properties: ClassVar[List[str]] = ["refundId"]
