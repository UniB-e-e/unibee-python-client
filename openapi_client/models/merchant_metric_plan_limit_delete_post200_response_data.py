...
class MerchantMetricPlanLimitDeletePost200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of merchant_metric_plan_limit
        if self.merchant_metric_plan_limit:
            _dict['merchantMetricPlanLimit'] = self.merchant_metric_plan_limit.to_dict()
        return _dict
