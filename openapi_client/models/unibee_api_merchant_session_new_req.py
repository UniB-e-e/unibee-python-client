...
class UnibeeApiMerchantSessionNewReq(BaseModel):
    """
    ...
    return_url: Optional[StrictStr] = Field(default=None, description="ReturnUrl", alias="returnUrl")
    __properties: ClassVar[List[str]] = ["address", "email", "externalUserId", "firstName", "lastName", "password", "phone", "returnUrl"]
