...
class UnibeeInternalModelEntityOverseaPayMerchantMember(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "email", "firstName", "gmtCreate", "gmtModify", "id", "isDeleted", "lastName", "merchantId", "mobile", "password", "userName"]
