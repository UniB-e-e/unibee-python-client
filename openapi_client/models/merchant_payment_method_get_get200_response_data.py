...
class MerchantPaymentMethodGetGet200ResponseData(BaseModel):
    """
    MerchantPaymentMethodGetGet200ResponseData
    """ # noqa: E501
    method: Optional[UnibeeApiBeanPaymentMethod] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "method": UnibeeApiBeanPaymentMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
