...
class UnibeeApiSystemSubscriptionTestClockWalkReq(BaseModel):
    """
    UnibeeApiSystemSubscriptionTestClockWalkReq
    """ # noqa: E501
    new_test_clock: StrictInt = Field(description="NewTestClock", alias="newTestClock")
    subscription_id: StrictStr = Field(description="Subscription Id", alias="subscriptionId")
    __properties: ClassVar[List[str]] = ["newTestClock", "subscriptionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newTestClock": obj.get("newTestClock"),
