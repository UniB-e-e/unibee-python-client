...
class UnibeeInternalLogicWebhookMerchantWebhookEndpointVo(BaseModel):
    """
    ...
    webhook_events: Optional[List[StrictStr]] = Field(default=None, description="webhook_events,split dot", alias="webhookEvents")
    webhook_url: Optional[StrictStr] = Field(default=None, description="webhook url", alias="webhookUrl")
    __properties: ClassVar[List[str]] = ["createTime", "gmtModify", "id", "merchantId", "webhookEvents", "webhookUrl"]
