...
class UnibeeInternalLogicGatewayRoInvoiceItemDetailRo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "amountExcludingTax", "currency", "description", "periodEnd", "periodStart", "proration", "quantity", "tax", "taxScale", "unitAmountExcludingTax"]
