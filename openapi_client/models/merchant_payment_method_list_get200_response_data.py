...
class MerchantPaymentMethodListGet200ResponseData(BaseModel):
    """
    MerchantPaymentMethodListGet200ResponseData
    """ # noqa: E501
    method_list: Optional[List[UnibeeApiBeanPaymentMethod]] = Field(default=None, description="MethodList", alias="methodList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "methodList": [UnibeeApiBeanPaymentMethod.from_dict(_item) for _item in obj["methodList"]] if obj.get("methodList") is not None else None
        })
        return _obj
