...
class UnibeeApiMerchantSubscriptionCreatePreviewRes(BaseModel):
    """
    ...
    tax_percentage: Optional[StrictInt] = Field(default=None, alias="taxPercentage")
    ...
    __properties: ClassVar[List[str]] = ["addonParams", "addons", "currency", "email", "gateway", "invoice", "plan", "quantity", "taxPercentage", "totalAmount", "userId", "vatCountryCode", "vatCountryName", "vatNumber", "vatNumberValidate"]
