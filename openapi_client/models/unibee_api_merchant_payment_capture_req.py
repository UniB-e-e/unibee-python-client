...
class UnibeeApiMerchantPaymentCaptureReq(BaseModel):
    """
    UnibeeApiMerchantPaymentCaptureReq
    """ # noqa: E501
    capture_amount: StrictInt = Field(description="CaptureAmount, Cent", alias="captureAmount")
    currency: StrictStr = Field(description="Currency")
    external_capture_id: StrictStr = Field(description="ExternalCaptureId", alias="externalCaptureId")
    payment_id: StrictStr = Field(description="PaymentId", alias="paymentId")
    __properties: ClassVar[List[str]] = ["captureAmount", "currency", "externalCaptureId", "paymentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalCaptureId": obj.get("externalCaptureId"),
