...
class UnibeeApiMerchantSubscriptionCreateReq(BaseModel):
    """
    ...
    return_url: Optional[StrictStr] = Field(default=None, description="RedirectUrl", alias="returnUrl")
    ...
    __properties: ClassVar[List[str]] = ["addonParams", "confirmCurrency", "confirmTotalAmount", "discountCode", "gatewayId", "metadata", "paymentMethodId", "planId", "quantity", "returnUrl", "userId", "vatCountryCode", "vatNumber"]
