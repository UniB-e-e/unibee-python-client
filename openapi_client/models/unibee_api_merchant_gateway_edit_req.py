...
class UnibeeApiMerchantGatewayEditReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["gatewayId", "gatewayKey", "gatewaySecret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gatewayKey": obj.get("gatewayKey"),
            "gatewaySecret": obj.get("gatewaySecret")
        })
        return _obj
