...
class UnibeeApiBeanMerchantCountryConfigSimplify(BaseModel):
    """
    UnibeeApiBeanMerchantCountryConfigSimplify
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["countryCode", "merchantId", "name"]
