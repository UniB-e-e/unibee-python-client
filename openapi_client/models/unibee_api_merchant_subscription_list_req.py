...
class UnibeeApiMerchantSubscriptionListReq(BaseModel):
    """
    ...
    status: Optional[List[StrictInt]] = Field(default=None, description="Filter, Default All，Status，0-Init | 1-Create｜2-Active｜3-Suspend | 4-Cancel | 5-Expire")
    user_id: Optional[StrictInt] = Field(default=None, description="UserId", alias="userId")
    __properties: ClassVar[List[str]] = ["count", "page", "sortField", "sortType", "status", "userId"]
