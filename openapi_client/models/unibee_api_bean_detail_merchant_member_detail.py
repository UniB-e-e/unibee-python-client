...
class UnibeeApiBeanDetailMerchantMemberDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "email", "firstName", "id", "lastName", "merchantId", "mobile", "permissions", "role"]
