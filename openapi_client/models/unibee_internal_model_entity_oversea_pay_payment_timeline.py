...
class UnibeeInternalModelEntityOverseaPayPaymentTimeline(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "currency", "gatewayId", "gmtCreate", "gmtModify", "id", "invoiceId", "isDeleted", "merchantId", "paymentId", "status", "subscriptionId", "timelineType", "totalAmount", "uniqueId", "userId"]
