...
class UnibeeInternalLogicGatewayRoUserAccountSimplify(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "createTime", "email", "externalUserId", "firstName", "id", "lastName", "merchantId"]
