...
class UnibeeApiMerchantSubscriptionAdminNoteRo(BaseModel):
    """
    ...
    mobile: Optional[StrictStr] = Field(default=None, description="手机号")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "email", "firstName", "id", "lastName", "mobile", "note", "subscriptionId", "userName"]
