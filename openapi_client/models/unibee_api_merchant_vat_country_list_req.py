...
class UnibeeApiMerchantVatCountryListReq(BaseModel):
    """
    UnibeeApiMerchantVatCountryListReq
    """ # noqa: E501
    merchant_id: StrictInt = Field(description="MerchantId", alias="merchantId")
