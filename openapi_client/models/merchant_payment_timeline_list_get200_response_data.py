...
class MerchantPaymentTimelineListGet200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payment_time_lines (list)
        _items = []
        if self.payment_time_lines:
            for _item in self.payment_time_lines:
                if _item:
                    _items.append(_item.to_dict())
            _dict['paymentTimeLines'] = _items
        return _dict
