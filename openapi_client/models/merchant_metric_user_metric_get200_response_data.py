...
class MerchantMetricUserMetricGet200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of user_metric
        if self.user_metric:
            _dict['userMetric'] = self.user_metric.to_dict()
        return _dict
