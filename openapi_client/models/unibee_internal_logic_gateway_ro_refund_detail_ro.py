...
class UnibeeInternalLogicGatewayRoRefundDetailRo(BaseModel):
    """
    UnibeeInternalLogicGatewayRoRefundDetailRo
    """ # noqa: E501
    payment: Optional[UnibeeInternalLogicGatewayRoPaymentSimplify] = None
    refund: Optional[UnibeeInternalLogicGatewayRoRefundSimplify] = None
    user: Optional[UnibeeInternalLogicGatewayRoUserAccountSimplify] = None
    __properties: ClassVar[List[str]] = ["payment", "refund", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payment": UnibeeInternalLogicGatewayRoPaymentSimplify.from_dict(obj["payment"]) if obj.get("payment") is not None else None,
            "refund": UnibeeInternalLogicGatewayRoRefundSimplify.from_dict(obj["refund"]) if obj.get("refund") is not None else None,
