...
class UnibeeApiBeanSubscriptionSimplify(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addonData", "amount", "billingCycleAnchor", "cancelAtPeriodEnd", "cancelReason", "countryCode", "createTime", "currency", "currentPeriodEnd", "currentPeriodStart", "defaultPaymentMethodId", "dunningTime", "firstPaidTime", "gasPayer", "gatewayId", "gatewayItemData", "gatewayStatus", "id", "lastUpdateTime", "latestInvoiceId", "link", "merchantId", "metadata", "pendingUpdateId", "planId", "quantity", "returnUrl", "status", "subscriptionId", "taskTime", "taxPercentage", "testClock", "trialEnd", "type", "userId", "vatNumber"]
