...
class UnibeeInternalLogicGatewayRoInvoiceDetailRo(BaseModel):
    """
    ...
    lines: Optional[List[UnibeeInternalLogicGatewayRoInvoiceItemDetailRo]] = Field(default=None, description="lines json data")
    ...
    payment: Optional[UnibeeInternalModelEntityOverseaPayPayment] = None
    ...
    refund: Optional[UnibeeInternalModelEntityOverseaPayRefund] = None
    ...
    subscription: Optional[UnibeeInternalModelEntityOverseaPaySubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment": UnibeeInternalModelEntityOverseaPayPayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None,
            "paymentId": obj.get("paymentId"),
            "periodEnd": obj.get("periodEnd"),
            "periodStart": obj.get("periodStart"),
            "refund": UnibeeInternalModelEntityOverseaPayRefund.from_dict(obj["refund"]) if obj.get("refund") is not None else None,
            ...
            "subscription": UnibeeInternalModelEntityOverseaPaySubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
            ...
            "userAccount": UnibeeInternalModelEntityOverseaPayUserAccount.from_dict(obj["userAccount"]) if obj.get("userAccount") is not None else None,
