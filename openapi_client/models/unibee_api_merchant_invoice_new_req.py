...
class UnibeeApiMerchantInvoiceNewReq(BaseModel):
    """
    UnibeeApiMerchantInvoiceNewReq
    """ # noqa: E501
    currency: StrictStr = Field(description="Currency")
    finish: Optional[StrictBool] = None
    gateway_id: StrictInt = Field(description="Gateway Id", alias="gatewayId")
    lines: Optional[List[UnibeeApiMerchantInvoiceNewInvoiceItemParam]] = None
    name: Optional[StrictStr] = Field(default=None, description="Name")
    tax_percentage: StrictInt = Field(description="TaxPercentage，1000 represent 10%", alias="taxPercentage")
    user_id: StrictInt = Field(description="UserId", alias="userId")
    __properties: ClassVar[List[str]] = ["currency", "finish", "gatewayId", "lines", "name", "taxPercentage", "userId"]
