...
class UnibeeApiMerchantMetricNewEventReq(BaseModel):
    """
    UnibeeApiMerchantMetricNewEventReq
    """ # noqa: E501
    external_event_id: StrictStr = Field(description="ExternalEventId, __unique__", alias="externalEventId")
    ...
    metric_properties: Optional[Dict[str, Any]] = Field(default=None, alias="metricProperties")
    __properties: ClassVar[List[str]] = ["externalEventId", "externalUserId", "metricCode", "metricProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metricProperties": obj.get("metricProperties")
        })
        return _obj
