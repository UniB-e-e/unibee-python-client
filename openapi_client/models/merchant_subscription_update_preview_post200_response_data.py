...
class MerchantSubscriptionUpdatePreviewPost200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of next_period_invoice
        if self.next_period_invoice:
            _dict['nextPeriodInvoice'] = self.next_period_invoice.to_dict()
        return _dict
